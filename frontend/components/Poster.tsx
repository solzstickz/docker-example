...
export default function Poster({ ...props }) {
  return (
    <>
      <div className="update_new-item  mx-auto flex flex-col relative  min-w-[180px] md:min-w-[200px]  hover:scale-105 transition-all ease-out delay-100  dark:text-text_color text-color_dark_gray hover:text-site_color shadow-2xl rounded-md hover:border-none">
        <Link href={`/series/${props.pages_slug}`}>
          <div className="update_new-item-img min-w-[180px] h-[270px]  relative mx-auto">
            <Image
